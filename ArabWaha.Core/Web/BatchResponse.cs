	...
	public static class BatchResponse
	{
		...
		public static SurveyContainer GetSurvey(string Response)
		{
			...
			try
			{
				...
				if (batchResponseDetailList[1].IndividualBatchResponse != null)
					SurveyContainer.SurveyQuestionResultListRoot = JsonConvert.DeserializeObject<SurveyQuestionResultListRoot>(batchResponseDetailList[1].IndividualBatchResponse.ToString());
			}
			catch (Exception ex)
			{
				Debug.WriteLine(ex);
		...
		public static ObligationContainer GetObligations(string Response)
		{
			...
			try
			{
				...
				if (batchResponseDetailList[3].IndividualBatchResponse != null)
					ObligationContainer.ProgramTermsRoot = JsonConvert.DeserializeObject<ProgramTermsRoot>(batchResponseDetailList[3].IndividualBatchResponse.ToString());
				if (batchResponseDetailList[4].IndividualBatchResponse != null)
				{
					ObligationContainer.SurveyRoot = JsonConvert.DeserializeObject<SurveyRoot>(batchResponseDetailList[4].IndividualBatchResponse.ToString());
		...
		public static List<CompanyObjectRoot> GenerateCompanyModel(string Response)
		{
			...
			try
			{
				...
				{
					if(item!=null && item.IndividualBatchResponse!=null)
		...
		public static List<JobDetailSetRoot> GenerateAppliedJobListModel(string Response)
		{
			JobDetailBatchContainer batchContainer = new JobDetailBatchContainer();
			List<JobDetailSetRoot> listOfJobsDetais = null;
			try
			{
				List<BatchResponseDetail> batchResponseDetailList = Parse(Response);
				listOfJobsDetais = new List<JobDetailSetRoot>();
				foreach (var item in batchResponseDetailList)
				{
					if(item!=null && item.IndividualBatchResponse!=null)
						listOfJobsDetais.Add(JsonConvert.DeserializeObject<JobDetailSetRoot>(item.IndividualBatchResponse.ToString()));
				}
			}
			catch (Exception er)
			{

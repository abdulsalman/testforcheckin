...
namespace ArabWaha
{
	...
	public class AddToWatchListResult
	{
		...
		public List<AddToWatchList> AddToWatchList { get; set; }
	}
	public class AddToWatchListRoot
	{
		[JsonProperty("d")]
		public AddToWatchListResult AddToWatchListResult { get; set; }
	}
	...
	public class JobDetailsDtoWatch
	{
        ...
        public string IndividualApplicationStatus
        {
            get
            {
                if (applicationStatus != null)
                    return LocalizationHelper.GetString(applicationStatus);
                else
                    return "";
            }
            set

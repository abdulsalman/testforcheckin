...
namespace ArabWaha
{
	...
	public class CompanyLocation
	{
		...
		/// </summary>
		/// <value>The longitude.</value>
		[JsonProperty("streetNameandNo")]
		public string StreetNameAndNo { get; set; }
		/// <summary>
		/// Gets or sets the longitude.
		/// </summary>
		/// <value>The longitude.</value>
	...
	public class JobDetail
	{
		...
		private string jobTypeLocal = string.Empty;
		/// <summary>
		...
		public string JobType
		{
			get
			{
				string dictoryValue = string.Empty;
				JobTypeEnum jobType = (JobTypeEnum)Enum.Parse(typeof(JobTypeEnum), jobTypeLocal);
				var key = string.Concat("JOBTYPE_", Convert.ToString(jobType));
				dictoryValue = LocalizationHelper.GetString(key);
				return dictoryValue;
			}
			set
			{
		...
		private string occupationLocal = string.Empty;
		/// <summary>
		...
		public string Occupations
		{
			get
			{
				var dictionoryValue = LocalizationHelper.GetString(occupationLocal);
				if (string.IsNullOrEmpty(dictionoryValue)) dictionoryValue = occupationLocal;
				return dictionoryValue;
			}
			set
			{
				occupationLocal = value;
			}
		}
		/// <summary>
		...
		public string Education
		{
			get
			{
				var dictionoryValue = LocalizationHelper.GetString(educationLocal);
				if (string.IsNullOrEmpty(dictionoryValue)) dictionoryValue = educationLocal;
				return dictionoryValue;
			}
			set
			{
				educationLocal = value;
			}
		}
		/// <summary>
		...
		/// </summary>
		/// <value>The type of the specialization major first level.</value>
		[JsonProperty("specializationMajorSecondLevelType")]
		public string SpecializationMajorSecondLevelType { get; set; }

		/// <summary>
		/// Gets or sets the type of the specialization major first level.
		/// </summary>
		/// <value>The type of the specialization major first level.</value>
		[JsonProperty("specializationMajorThirdLevelType")]
		public string SpecializationMajorThirdLevelType { get; set; }
		...
		private string WorkTimeLocal = string.Empty;
		[JsonProperty("workTime")]
		public string WorkTime
		{
			get
			{
				var dictionoryValue = LocalizationHelper.GetString(WorkTimeLocal);
				if (string.IsNullOrEmpty(dictionoryValue)) dictionoryValue = WorkTimeLocal;
				return dictionoryValue;
			}
			set
			{
		...
		private string teleworkingLocal = string.Empty;
		[JsonProperty("teleworking")]
		public string Teleworking
		{
			get
			{
				var dictionoryValue = LocalizationHelper.GetString(teleworkingLocal);
				if (string.IsNullOrEmpty(dictionoryValue)) dictionoryValue = teleworkingLocal;
				return dictionoryValue;
			}
			set
			{
				teleworkingLocal = value;
			}
		...
		public string Status
		{
			get
			{
				var dictionoryValue = LocalizationHelper.GetString(jobStatus);
				if (string.IsNullOrEmpty(dictionoryValue)) dictionoryValue = jobStatus;
				return dictionoryValue;
			}
			set
			{
		...
		{
			get 			{ 				int intValue = 0; 				int.TryParse(localShiftType, out intValue); 				ShiftTypeEnum shiftType = (ShiftTypeEnum)intValue; 				return LocalizationHelper.GetString(shiftType.ToString()); 			} 			set 			{ 				localShiftType = value; 			}
		}
		/// <summary>
		/// Gets or sets the mobility.
		/// </summary>
		/// <value>The mobility.</value>
		private string mobilityLoal = string.Empty;
		...
		public string Mobility
		{
			...
			{
				int intValue = 0;
				int.TryParse(mobilityLoal, out intValue);
				MobilityEnum mobilityType = (MobilityEnum)intValue;
				return LocalizationHelper.GetString(mobilityType.ToString());
			}
			set
			{
				mobilityLoal = value;
